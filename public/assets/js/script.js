...
const zookeeperFormHandler = event => {
  event.preventDefault();

  // get zookeeper data and organize it
  const name = $zookeeperForm.querySelector('[name = "zookeeper-name"');
  const age = $zookeeperForm.querySelector('[name = "age');
...
$zookeeperForm.addEventListener('submit', zookeeperFormHandler);
